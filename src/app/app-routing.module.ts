...
//==========Lab Technician=======================
  ...
  { path: 'patient-list', component: PatientListComponent,canActivate:[AuthGuard] , data: { RoleId: '3' }},
  { path: 'patient-list/dashboard', component: PatientListComponent,canActivate:[AuthGuard] , data: { RoleId: '3' } },
  { path: 'add-patient', component: PatientComponent,canActivate:[AuthGuard] , data: { RoleId: '3' } },
  { path: 'update-patient/:pID', component: PatientComponent ,canActivate:[AuthGuard] , data: { RoleId: '3' }},
  {
