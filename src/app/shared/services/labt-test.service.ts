...
export class LabtTestService {
  ...
  bindListReports(){
    this.httpClient.get( environment.apiUrl + '/api/TestReport').toPromise().then(
      response => {
  ...
  bindListReportsforPharm(id:number){
    this.httpClient.get( environment.apiUrl + '/api/TestReport/GetReports/'+id).toPromise().then(
      response => {
        console.log("From Lab test service fetching Test Reports");
        console.log(response);
        this.testview = response as Testrep[];
  ...
  bindListReportsById(id:number){
    this.httpClient.get( environment.apiUrl + '/api/TestReport/'+id).toPromise().then(
      response => {
 ...
 bindListTestReports(){
    this.httpClient.get( environment.apiUrl + '/api/LabBill').toPromise().then(response=>{
  ...
  insertLabBill(labbill:any): Observable<any>{
    return this.httpClient.post( environment.apiUrl + '/api/LabBill',labbill);
  }
  //----------------PATCH------------------
  updateLabReportTests(id:number,patch:any):Observable<any>
  {
    return this.httpClient.patch( environment.apiUrl + '/api/TestAdvice/'+id,patch);
  }
  updateLabReport(id:number,patch:any):Observable<any>
  {
    return this.httpClient.patch( environment.apiUrl + '/api/TestReport/'+id,patch);
  }
