...
export class PharmacistService {
  ...
  insertMedicineBill(med:any): Observable<any> {
    return this.httpClient.post(  environment.apiUrl + '/api/MedicineBill',med );
  }
...
{
  return this.httpClient.patch( environment.apiUrl + '/api/MedicineAdvice/'+id,mpat);
}

updateMedStock(medname:string,pathca:any)
{
  return this.httpClient.patch( environment.apiUrl + '/api/Medicines/'+medname,pathca);
}
  //==============
}
