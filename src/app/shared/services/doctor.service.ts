...
export class DoctorService {
  ...
  bindListAppointments(id: number) {
    this.httpClient
      .get(
        environment.apiUrl + '/api/Appointments/ViewAppointmentsByDoctorId/' + id
      )
      .toPromise()
      .then((response) => {
  ...
  bindListAppointmentsForToday(id: number) {
    this.httpClient
      .get(environment.apiUrl + '/api/Appointments/ViewTodaysAppointments/' + id)
      .toPromise()
      .then((response) => {
        this.appointments = response as Appointments[];
        console.log(response);
  ...
  BindTechnicianList() {
    this.httpClient
      .get( environment.apiUrl + '/api/Role/Staffs/4')
      .toPromise()
      .then((response) => {
  ...
  BindPharmList() {
    this.httpClient
      .get( environment.apiUrl + '/api/Role/Staffs/5')
      .toPromise()
      .then((response) => {
  ...
  insertMedicineAdvice(medadv: any): Observable<any> {
    return this.httpClient.post(
       environment.apiUrl + '/api/MedicineAdvice',
      medadv
    );
  }
  ...
  insertTestAdvice(testadv: any): Observable<any> {
    return this.httpClient.post(
       environment.apiUrl + '/api/TestReport',
      testadv
    );
  }
